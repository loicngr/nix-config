...

{
  ...
  xdg.configFile."kanshi/config".text = ''
    ...
    profile home {
      ...
      output "Ancor Communications Inc ASUS VN247 E3LMTF096472" enable mode 1920x1080 position 0,160 scale 1
      output "ASUSTek COMPUTER INC VG27A R4LMQS045267" enable mode 2560x1440@59.951Hz position 1920,0 scale 1
    }

    profile work {
      output eDP-1 disable
      output "Dell Inc. DELL E2416H 5K4MY63S270U" enable mode 1920x1080@60.000 position 0,0 scale 1
      output "Samsung Electric Company C27F390 H4LTB01542" enable mode 1920x1080@60.000 position 1920,0 scale 1
    }
  '';
