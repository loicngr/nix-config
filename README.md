...
└── scripts/
    ...
    ├── php-cs-fixer-wrapper.sh # Wrapper PHP-CS-Fixer
    ├── phpstan-wrapper.sh     # Wrapper PHPStan
...
Environnements PHP 8.2 et 8.3 avec extensions complètes.

**Exports :** `myPhp82`, `myPhp83`
