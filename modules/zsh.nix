...

{
  programs.zsh = {
    ...
    shellAliases = {
      ...
      php84 = "PHP_INI_SCAN_DIR=${myPhp84}/lib ${myPhp84}/bin/php";
      php85 = "PHP_INI_SCAN_DIR=${myPhp85}/lib ${myPhp85}/bin/php";
      composer83 = "PHP_INI_SCAN_DIR=${myPhp83}/lib ${myPhp83.packages.composer}/bin/composer";
      composer84 = "PHP_INI_SCAN_DIR=${myPhp84}/lib ${myPhp84.packages.composer}/bin/composer";
      composer85 = "PHP_INI_SCAN_DIR=${myPhp85}/lib ${myPhp85.packages.composer}/bin/composer";
    };
    ...
    interactiveShellInit = ''
      ...
      use-php84() {
        ...
        export PATH="${myPhp84}/bin:${myPhp84.packages.composer}/bin:$PATH"
        alias composer="${myPhp84.packages.composer}/bin/composer"
        echo "✓ PHP 8.4 activé (php: ${myPhp84}/bin/php, composer: ${myPhp84.packages.composer}/bin/composer)"
      }

      use-php85() {
        export PHP_INI_SCAN_DIR="${myPhp85}/lib"
        export PATH="${myPhp85}/bin:${myPhp85.packages.composer}/bin:$PATH"
        alias composer="${myPhp85.packages.composer}/bin/composer"
        echo "✓ PHP 8.5 activé (php: ${myPhp85}/bin/php, composer: ${myPhp85.packages.composer}/bin/composer)"
      }
